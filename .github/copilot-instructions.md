...
- **Backend**: Server actions in page directories (e.g., `src/app/signup/actions.ts`) for DB operations
...
- **Forms**: React Hook Form + Zod validation (e.g., `src/app/signup/page.tsx`)
